...
$.getJSON("../resources/data/hju_short_course_line.json", function (data) {
...
$.getJSON("../resources/data/hju_long_course_line.json", function (data) {
...
$.getJSON("../resources/data/hju_long_course_poi.json", function (data) {
...
$.getJSON("../resources/data/hju_short_course_poi.json", function (data) {
